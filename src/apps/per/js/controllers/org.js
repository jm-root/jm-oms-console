...
app.controller('OrgCtrl', ['$scope', '$state', '$http', function ($scope, $state, $http) {
    var sso = jm.sdk.sso;
    ...
    $scope.createNode = function() {
        $http.post(perUri+'/orgs', $scope.org, {
            params:{
                token: sso.getToken()
            }
        }).success(function(result){
    ...
    $scope.updateNode = function() {
        ...
        $http.post(perUri+'/orgs/'+id, $scope.org, {
            params:{
                token: sso.getToken()
            }
        }).success(function(result){
